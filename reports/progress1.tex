...
- Scalable – The system must be scalable in terms of capacity, performance 
...
- High Availability – The system should have high-availability functionality 
...
- Durability – The system should support the storage of data in a durable 
...
- Performance at Traditional SAN/NAS Level – The system should be able to 
...
- Dynamic Operation – The level of availability, durability and performance 
...
- Cost Effective – It should be possible to build, configure, run, and 
...
- Interfaces – The system should offer generic interfaces to applications 
...
- Protocols Based on Open Standards – The system should be built using 
...
- Multi-Party Access – The system should support access by multiple, 
...
llows data integrity to be maintained in the event that individual nodes 
...
1). Key-Value store : in which each key "capability" identifies a 
file/directory "value" on the grid. It provides PUT and GET operations. 

key = PUT(data) 
data = GET(key)

2). Decentralized File System Layer:  The key-value store provides the 
...
3). Application Layer:  Application specific features that use the 
...
Tahoe - Installation and Configuration
